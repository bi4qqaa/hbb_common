...
pub const RENDEZVOUS_SERVERS: &[&str] = &["58.210.43.14"];
pub const RS_PUB_KEY: &str = "YUJ59NjU7edRqSykV4dHD7SS08yEwdKDT05Re7suIRE=";

pub const RENDEZVOUS_PORT: i32 = 5668;
pub const RELAY_PORT: i32 = 5669;
